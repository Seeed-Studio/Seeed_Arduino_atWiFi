...
void unified_at_reset_callback() {
...
void unified_at_stat_change_callback() {
    uint8_t uni_st = esp.wifi.state;
    system_event_t event;

    // convert Unified State to system_event_id_t
    switch(uni_st) {
    case WifiDisconnect:
...
void unified_at_scan_done_callback() {
    system_event_t event;
...
void unified_at_rcv_pkt_callback() {
    // TODO:
    return;
}

int unified_event_register() {
    esp.whenReset              = unified_at_reset_callback;
    esp.wifi.whenScanFinished  = unified_at_scan_done_callback;
    esp.wifi.whenScanFailed    = unified_at_scan_done_callback;
    esp.wifi.whenStateChanged  = unified_at_stat_change_callback;
    esp.wifi.whenReceivePacket = unified_at_rcv_pkt_callback;
    return 0;
}
...
bool WiFiGenericClass::setTxPower(wifi_power_t power){
    ...
    int32_t pwr = WIFI_POWER_19_5dBm;

    switch(power){
    case WIFI_POWER_19_5dBm:    pwr = 0;  break;
    case WIFI_POWER_19dBm:      pwr = 1;  break;
    case WIFI_POWER_18_5dBm:    pwr = 2;  break;
    case WIFI_POWER_17dBm:      pwr = 3;  break;
    case WIFI_POWER_15dBm:      pwr = 4;  break;
    case WIFI_POWER_13dBm:      pwr = 5;  break;
    case WIFI_POWER_11dBm:      pwr = 6;  break;
    case WIFI_POWER_8_5dBm:     pwr = 7;  break;
    case WIFI_POWER_7dBm:       pwr = 8;  break;
    case WIFI_POWER_5dBm:       pwr = 9;  break;
    case WIFI_POWER_2dBm:       pwr = 10; break;
    case WIFI_POWER_MINUS_1dBm: pwr = 11; break;
    }
